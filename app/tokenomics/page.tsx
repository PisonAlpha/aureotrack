...
const ALLOCATION = [
  ...
  { name: 'Private Sale', percent: 1.11, tokens: 11111111, color: '#8b5cf6', description: 'Tokens sold at $0.18 per ART — 10% TGE, 18 months linear vesting' },
  { name: 'Angel Round', percent: 0.47, tokens: 4666667, color: '#ec4899', description: 'Tokens sold at $0.15 per ART — 10% TGE, 18 months linear vesting' },
  { name: 'Team & Advisors', percent: 18, tokens: 180000000, color: '#f97316', description: 'Locked 1 year, then 24-month linear vesting' },
  { name: 'Ecosystem & Development', percent: 10, tokens: 100000000, color: '#10b981', description: 'Platform infrastructure, APIs, and development over 36 months' },
  { name: 'Marketing & Growth', percent: 10, tokens: 100000000, color: '#06b6d4', description: 'Global marketing, partnerships, community growth over 24 months' },
  { name: 'Treasury', percent: 48.42, tokens: 484222222, color: '#6b7280', description: 'Locked 3 years — includes unsold public, private and angel tokens. DAO governed after Year 3' },
];

const VESTING = [
  { group: 'Community & Airdrop', tokens: '120M', tge: '43.75%', cliff: 'None', vesting: '36 months linear', y1: '43.75%', y2: '75%', y3: '100%' },
  { group: 'Private Sale', tokens: '11.1M', tge: '10%', cliff: '3 months', vesting: '18 months linear', y1: '75%', y2: '100%', y3: '100%' },
  { group: 'Angel Round', tokens: '4.7M', tge: '10%', cliff: '3 months', vesting: '18 months linear', y1: '75%', y2: '100%', y3: '100%' },
  ...
  { group: 'Treasury', tokens: '484.2M', tge: '0%', cliff: '36 months', vesting: 'DAO governed post Year 3', y1: '0%', y2: '0%', y3: '0%*' },
];

const DISTRIBUTION = [
  { period: 'TGE', circ: 52.5, priv: 1.1, angel: 0.5, team: 0, eco: 5, mkt: 10, treasury: 0 },
  { period: 'M3', circ: 52.5, priv: 4.4, angel: 1.9, team: 0, eco: 13, mkt: 20, treasury: 0 },
  { period: 'M6', circ: 52.5, priv: 7.8, angel: 3.3, team: 0, eco: 22, mkt: 30, treasury: 0 },
  { period: 'M12', circ: 52.5, priv: 11.1, angel: 4.7, team: 0, eco: 38, mkt: 50, treasury: 0 },
  { period: 'M18', circ: 52.5, priv: 11.1, angel: 4.7, team: 45, eco: 55, mkt: 70, treasury: 0 },
  { period: 'M24', circ: 52.5, priv: 11.1, angel: 4.7, team: 90, eco: 72, mkt: 100, treasury: 0 },
  { period: 'M30', circ: 52.5, priv: 11.1, angel: 4.7, team: 135, eco: 88, mkt: 100, treasury: 0 },
  { period: 'M36', circ: 52.5, priv: 11.1, angel: 4.7, team: 180, eco: 100, mkt: 100, treasury: 484.2 },
];

const FUNDING = [
  { round: 'Angel Round', raised: '$700,000', price: '$0.15', tokens: '4,666,667 ART', date: 'Q1 2025', status: 'Closed', valuation: '$15M', color: '#f59e0b', bg: 'from-amber-50 to-yellow-50', border: 'border-amber-200' },
  { round: 'Private Sale', raised: '$2,000,000', price: '$0.18', tokens: '11,111,111 ART', date: 'Q2 2026', status: 'Closed', valuation: '$18M', color: '#8b5cf6', bg: 'from-violet-50 to-purple-50', border: 'border-violet-200' },
      ...
      <div className="py-10 px-4 border-b border-white/10">
        <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            { label: 'Initial Circulating', value: '6.91%', sub: '69,077,778 ART at TGE', color: '#3b82f6' },
            { label: 'Treasury Allocation', value: '48.42%', sub: '484,222,222 ART locked 3yr', color: '#6b7280' },
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 space-y-16">
        ...
        <section>
          <div className="mb-8">
            ...
            <p className="text-gray-500">1,000,000,000 ART total supply — only 6.91% circulating at TGE</p>
          </div>
        ...
        <section>
          ...
          <div className="rounded-3xl overflow-hidden p-8" style={{ background: 'linear-gradient(135deg, #1a1a2e 0%, #1e2a3a 100%)', boxShadow: '0 20px 60px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.05)' }}>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { label: 'At TGE (Month 0)', value: '~69.1M ART', sub: '6.91% circulating', color: '#f59e0b' },
                { label: 'End of Year 2', value: '~515.8M ART', sub: '51.58% circulating', color: '#3b82f6' },
        ...
        <section>
          ...
          <div className="rounded-3xl overflow-hidden" style={{ boxShadow: '0 20px 60px rgba(0,0,0,0.5)' }}>
            ...
            <p className="text-xs text-gray-600 px-5 py-3" style={{ background: 'rgba(255,255,255,0.02)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>* Treasury (48.42%) locked for 3 full years. Post-Year 3 release governed by ART token holder DAO vote.</p>
          </div>
        </section>
        ...
        <section>
              ...
              <div key={i} className={`relative rounded-2xl overflow-hidden`} style={{ boxShadow: '0 20px 40px rgba(0,0,0,0.4), 0 1px 0 rgba(255,255,255,0.05) inset' }}>
                <div className={`bg-gradient-to-br ${round.bg} p-6`}>
                  <div className="flex items-start justify-between mb-5">
                    ...
                    <span className="px-3 py-1 rounded-full text-xs font-bold bg-gray-900/10 text-gray-700">
                      ✓ {round.status}
                    </span>
                  </div>
                  <p className="text-3xl font-black mb-4" style={{ color: round.color }}>{round.raised}</p>
                  <div className="space-y-2">
                    {[['Token Price', round.price], ['Tokens Sold', round.tokens], ['Valuation', round.valuation]].map(([k, v]) => (
          ...
          <p className="text-xs text-gray-600 mt-3">Unsold tokens from Angel Round and Private Sale have been added to Treasury allocation.</p>
        </section>
        ...
        <section>
          <div className="mb-8">
            ...
            <p className="text-gray-500">How the $3,000,000 raised will be deployed</p>
          </div>
        ...
        <div className="rounded-2xl p-6" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)' }}>
          <p className="text-xs text-gray-500 leading-relaxed">
            <span className="text-yellow-400 font-semibold">Legal Disclaimer:</span> This tokenomics document is for informational purposes only and does not constitute financial advice or an offer to sell securities. The ART token is a utility token. Unsold tokens from Angel Round and Private Sale allocations have been consolidated into the Treasury. Treasury tokens are locked for 3 full years and released via DAO governance. AureoTrack was founded in 2025.
          </p>
        </div>
